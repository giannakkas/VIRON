...
NEWS_KEYWORDS = [
    "νέα", "news", "ειδήσ", "ειδησ", "ιδίσ", "ιδισ", "ιδήσ",
    "σίτισ", "σιτισ", "ειτισ",  # Whisper misspellings of ειδήσεις
    "ειδήσεις", "ειδησεις", "ιδίσεις", "ιδισεις", "ιδήσεις", "σίτισης",
    "headlines", "τι γίνεται στον κόσμο",
    "what's happening", "τι έγινε σήμερα", "what happened today",
    "τελευταία νέα", "latest news", "ενημέρωσ", "update",
    "σήμερα νέα", "νεα", "τι νέα", "τι νεα",
